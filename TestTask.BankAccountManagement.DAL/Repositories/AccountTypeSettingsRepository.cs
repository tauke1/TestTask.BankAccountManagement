...
{
    public class AccountTypeSettingsRepository : BaseRepository<AccountTypeSettings>, IAccountTypeSettingsRepository
    {
        public AccountTypeSettingsRepository(AppDbContext context) : base(context)
        {
        }
    }
}
